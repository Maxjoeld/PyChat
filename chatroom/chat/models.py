...
class TrackableDateModel(models.Model):
    ...
    # Abstract base class- This class will be inherited from other classes
    class Meta:
        abstract = True
...
def _generate_unique_uri():
    ...
    #uuid is identification number that will uniquely identify something
    #can create as many as you want and will never have the same ID's
